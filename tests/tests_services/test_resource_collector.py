...
def test_aws_policies():
    policies = CustodianResourceCollector.build().load_aws_policies()
...
def test_azure_policies(mock_run_command, mock_credential):
    ...
    policies = CustodianResourceCollector.build().load_azure_policies()
...
def test_gcp_policies():
    policies = CustodianResourceCollector.build().load_google_policies()
