...
data: tuple[EndpointInfo, ...] = (
    ...
    EndpointInfo(
        ...
        method=HTTPMethod.POST,
        lambda_name=LambdaName.CONFIGURATION_API_HANDLER,
        request_model=RuleSourceSyncModel,
    ...
    EndpointInfo(
        ...
        lambda_name=LambdaName.CONFIGURATION_API_HANDLER,
        request_model=BaseModel,
        responses=[(HTTPStatus.OK, SingleMcpAuthModel, None)],
        permission=Permission.INTEGRATIONS_MCP_DESCRIBE_AUTH,
        description='Allows to describe MCP JWT auth configuration',
    ),
    EndpointInfo(
        path=Endpoint.INTEGRATIONS_MCP_AUTH,
        method=HTTPMethod.POST,
        lambda_name=LambdaName.CONFIGURATION_API_HANDLER,
        request_model=McpAuthSettingPostModel,
        responses=[(HTTPStatus.CREATED, SingleMcpAuthModel, None)],
        permission=Permission.INTEGRATIONS_MCP_CREATE_AUTH,
        description='Allows to add MCP JWT auth configuration',
    ),
    EndpointInfo(
        path=Endpoint.INTEGRATIONS_MCP_AUTH,
        method=HTTPMethod.PATCH,
        lambda_name=LambdaName.CONFIGURATION_API_HANDLER,
        request_model=McpAuthSettingPatchModel,
        responses=[(HTTPStatus.OK, SingleMcpAuthModel, None)],
        permission=Permission.INTEGRATIONS_MCP_UPDATE_AUTH,
        description='Allows to update MCP JWT auth configuration',
    ),
    EndpointInfo(
        path=Endpoint.INTEGRATIONS_MCP_AUTH,
        method=HTTPMethod.DELETE,
        ...
        request_model=BaseModel,
        responses=[(HTTPStatus.NO_CONTENT, None, None)],
        permission=Permission.INTEGRATIONS_MCP_DELETE_AUTH,
        description='Allows to delete MCP JWT auth configuration',
    ),
    # Users
    EndpointInfo(
