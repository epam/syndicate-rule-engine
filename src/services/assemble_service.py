...
from helpers.constants import (
    ...
    BATCH_ENV_MIN_CUSTOM_CORE_VERSION, BATCH_ENV_CURRENT_CUSTOM_CORE_VERSION,
...
class AssembleService:
    ...
    def build_job_envs(self, tenant: Tenant,
                       ...
                       current_core_version: Optional[str] = None
                       ) -> dict:
        ...
        envs = {
            ...
            BATCH_ENV_TARGET_REGIONS: ','.join(target_regions),
        }
        if target_rulesets:
