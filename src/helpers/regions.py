...
AWS_REGIONS = {'ap-northeast-1', 'af-south-1', 'eu-west-3', 'eu-south-2',
               'ap-southeast-4', 'eu-west-2', 'eu-north-1', 'ap-southeast-3',
               'ap-southeast-2', 'us-east-2', 'eu-west-1', 'ap-south-1',
               'us-east-1', 'ap-east-1', 'us-gov-east-1', 'ap-northeast-2',
               'me-south-1', 'il-central-1', 'ca-west-1', 'ap-northeast-3',
               'us-gov-west-1', 'us-west-1', 'ca-central-1', 'eu-south-1',
               'us-west-2', 'eu-central-2', 'ap-south-2', 'me-central-1',
