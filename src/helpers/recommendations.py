...
RULE_RECOMMENDATION_MAPPING = {
    ...
    "ecc-aws-186-ec2_instance_no_public_ip": {
        ...
        "recommendation": {"action": "MAKE_IP_PRIVATE"},
    },
    ...
    "ecc-gcp-033-vpc_flow_logs_for_every_subnet": {
        ...
        "recommendation": {"action": "ENABLE_FLOW_LOGS"},
    },
    "ecc-gcp-032-private_google_access_for_all_subnetworks": {
        ...
        "meta": None,
        "general_actions": ["SUBNET"],
        "recommendation": {"action": "ENABLE_PRIVATE_GOOGLE_ACCESS"},
    },
    "ecc-gcp-034-no_instances_default_service_account_with_full_cloud_api_access": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "RESTRICT_FULL_ACCESS"},
    },
    "ecc-gcp-035-block_project-wide_ssh_keys_for_instances": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "BLOCK_PROJECT_WIDE_SSH"},
    },
    "ecc-gcp-038-not_ip_forwarding_on_instance": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "DISABLE_IP_FORWARDING"},
    },
    ...
    "ecc-gcp-104-default_firewall_rule_in_use": {
        ...
        "meta": None,
        "general_actions": ["SECURITY_GROUP"],
        "recommendation": {"action": "REMOVE_DEFAULT_FIREWALL", "port": []},
    },
    ...
    "ecc-gcp-151-vm_instances_enabled_with_pre-emptible_termination": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "DISABLE_PRE_EMPTIBLE_TERMINATION"},
    },
    "ecc-gcp-171-not_default_service_account_on_instance": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "REMOVE_DEFAULT_SERVICE_ACCOUNT"},
    },
    ...
    "ecc-gcp-194-oslogin_disabled_for_instance": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "ENABLE_OS_LOGIN"},
    },
    "ecc-gcp-195-clouddns_logging_is_enabled_for_all_vpc_networks": {
        ...
        "meta": None,
        "general_actions": ["VPC"],
        "recommendation": {"action": "ENABLE_DNS_LOGGING"},
    },
    "ecc-gcp-228-on_host_maintenance_set_to_migrate_for_instance": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "ENABLE_LIVE_MIGRATION"},
    },
    "ecc-gcp-232-instance_configured_with_enable_oslogin_2fa": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "ENABLE_OF_LOGIN_2FA"},
    },
    ...
    "ecc-azure-113-cis_vm_utilizing_managed_disks": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "UNMANAGED_DISKS"},
    },
    "ecc-azure-116-cis_vm_endpoint_protection": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "CONFIGURE_ENDPOINT_PROTECTION"},
    },
    "ecc-azure-184-asb_vm_linux_ssh_auth_req": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "CONFIGURE_SSH_AUTHENTICATION"},
    },
    "ecc-azure-197-asb_vm_disk_encryption_on": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "ENABLE_DISC_ENCRYPTION"},
    },
    "ecc-azure-231-asb_vm_wo_mma": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "CONFIGURE_LOG_ANALYTICS_AGENT"},
    },
    "ecc-azure-275-asb_vm_backup": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "CONFIGURE_BACKUP"},
    },
    "ecc-azure-367-vm_omi_vulnerability": {
        ...
        "meta": None,
        "general_actions": ["INSTANCE"],
        "recommendation": {"action": "PROTECT_FROM_OMI_VULNERABILITY"},
    },
...
K8S_RECOMMENDATION_MODEL = {
    ...
    "source": SOURCE,
    "severity": "HIGH",
    "stats": {"scan_date": None, "status": "OK", "message": "Processed successfully"},
    "meta": None,
